...
setwd("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/SST_Bleaching")
sst_sat <- read.csv(file = "Temperature_Bleaching_2019.csv", header = T, dec = ".", sep = ";")
...
dat <- read.csv("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/Bleaching_Survey_Preliminary.csv", sep=";", dec=",")
...
setwd("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/Bayesian")
load("fit_brms_Bleaching.RData") 
...
plot_general
ggsave("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Bayesian/Figures/plot_general.pdf", width = 30, height = 30, units = "cm")
...
setwd("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data")
deep_bleaching <- read.csv(file = "~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Bleaching_Survey_Preliminary.csv", header = T, dec = ".", sep = ";")
...
fp_upper_lower
ggsave("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Bayesian/Figures/fp_upper_lower.pdf", width = 13, height = 20, units = "cm")
...
status_genera
ggsave("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Bayesian/Figures/status_genera.pdf", width = 30, height = 30, units = "cm")
...
setwd("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data")
deep_bleaching <- read.csv(file = "Bleaching_Survey_Preliminary.csv", header = T, dec = ".", sep = ";")
...
Islands
ggsave("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Figures/Islands.pdf", width = 13, height = 11, units = "cm")
...
# Choose directory where you have CSV and function reading
setwd("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/Temperature_Loggers/MOO1")

# Introduce filenames of the folder between " " .
# Very importanct to put them in same order than prof

file.names = c("MO1-20-temp.csv","MO1-40-temp.csv","MO1-60-temp.csv","MO1-90-temp.csv","MO1-120-temp.csv")
prof = c(20,40,60,90,120)
df_all=data.frame()

# Introduce limits of time, to get to the depth and to take it out "Year-M-D h:m:s"
check_time_date <- read.csv ("MO1-120-temp.csv",header = F, dec = ".", sep = ",", skip = 1)
...
plot_bleaching
ggsave ( "~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Figures/Temp_Raw_Mooz.pdf", plot_bleaching,width = 4.8, height = 4.5)
...
write.csv(Index_temp, "~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Temperature_Loggers/MOO1/MOO1_Temp_Index.csv")

ggsave ( "~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Figures/Temp_Index_Moo.pdf", plot,width = 4.8, height = 4.5) 
...
# Choose directory where you have CSV and function reading
setwd("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/Temperature_Loggers/MAK1")
# Introduce filenames of the folder between " " .
# Very importanct to put them in same order than prof


# Introduce filenames of the folder between " " 
file.names = c("MAK1-6-temp.csv","MAK1-20-temp.csv","MAK1-40-temp.csv","MAK1-60-temp.csv","MAK1-90-temp.csv", "MAK1-120-temp.csv")
prof = c(6,20,40,60,90,120)
df_all=data.frame()

# Introduce limits of time, to get to the depth and to take it out "Year-M-D h:m:s"
check_time_date <- read.csv ("MAK1-120-temp.csv",header = F, dec = ".", sep = ",", skip = 1)
# View (check_time_date)
...
plot_bleaching <- ggplot(data = df_all, aes (y=Temperature, x = Date_Time, group = Depth, color = Depth)) +
                  ...
                  guides(colour = guide_legend(reverse=F)) + theme(axis.line = element_line(colour = "black"), panel.background = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank())
plot_bleaching
ggsave ( "~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Figures/Temp_Raw_Mak.pdf", plot_bleaching,width = 4.8, height = 4.5)
...
write.csv(Index_temp, "~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Temperature_Loggers/MAKATEA/MAK1/MAK1_Temp_Index.csv")

ggsave ( "~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Figures/Temp_Index_Mak.pdf", plot,width = 4.8, height = 4.5) 
...
### For Moorea
# Choose directory where you have CSV and function reading
setwd("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/Light/Moo1")

# Introduce filenames of the folder between " " 
file.names = c("MO1-20-light.csv","MO1-40-light.csv","MO1-60-light.csv","MO1-90-light.csv","MO1-120-light.csv")
prof = c(20,40,60,90,120)
df_all=data.frame()
...
final_plot <- ggplot(data = df_all, aes (y=Quantum, x = Date_Time, group = Depth, color = Depth)) +
  ...
  theme(axis.line = element_line(colour = "black"), panel.background = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank())
final_plot
ggsave ( "~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Figures/Light_Raw_Mooz.pdf", final_plot,width = 4.8, height = 4.5)
...
setwd("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/Light/Moo1")
Index_light <- read.csv(file = "Light_Lambert_MOO1.csv", header = T, dec = ".", sep = ";")
...
write.csv(Index_light, "~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Light/Moo1/MOO1_Light_Index.csv")

ggsave ( "~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Figures/Light_Index_Moo.pdf", plot,width = 4.8, height = 4.5)


### For Makatea 
# Choose directory where you have CSV and function reading
setwd("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/Light/Mak1")


# Introduce filenames of the folder between " " 
file.names = c("MAK1-20-light.csv","MAK1-40-light.csv","MAK1-90-light.csv","MAK1-120-light.csv")
prof = c(20,40,90,120)
df_all=data.frame()

check_time_date <- read.csv ("MAK1-120-light.csv", header = F, dec = ".", sep = ",", skip = 1)
#View (check_time_date)
...
final_plot <- ggplot(data = df_all, aes (y=Quantum, x = Date_Time, group = Depth, color = Depth)) +
  ...
  theme(axis.line = element_line(colour = "black"), panel.background = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank())
final_plot
ggsave ( "~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Figures/Light_Raw_Mak.pdf", final_plot,width = 4.8, height = 4.5)
...
setwd("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/Light/Mak1")
Index_light <- read.csv(file = "Light_Lambert_MAK1.csv", header = T, dec = ".", sep = ";")
...
plot
######## This is the good one #########
ggsave ( "~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Figures/Light_Index_Mak.pdf", plot,width = 4.8, height = 4.5)
...
rm (list=ls())
# Loggers Temp
Index_Temp_Moorea <- read.csv("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/Temperature_Loggers/MOO1/MOO1_Temp_Index.csv", sep=",", dec=",")
Index_Temp_Makatea <- read.csv("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/Temperature_Loggers/MAK1/MAK1_Temp_Index.csv", sep=",", dec=",")

# Loggers light
Index_Light_Moorea <- read.csv("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/Light/Moo1/MOO1_Light_Index.csv", sep=",", dec=",")
Index_Light_Makatea <- read.csv("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/Light/Mak1/MAK1_Light_Index.csv", sep=",", dec=",")

# CTD Makatea 
CTD_Makatea <- read.csv("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/CTD/Makatea/normalize_PAR.csv", sep=",", dec=",")
PAR_final_six <- read.csv("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/CTD/Makatea/Makatea_PAR_final_six.csv", sep=",", dec=",")

Temp_final_six <- read.csv("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/CTD/Makatea/Makatea_Temp_final_six.csv", sep=",", dec=",")
...
ggsave("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Bayesian/Figures/islands.pdf", width = 30, height = 20, units = "cm")
...
write.csv(Healthy_Likelihood_Moorea, "~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Bayesian/Healthy_Likelihood_Moorea.csv")
...
write.csv(Healthy_Likelihood_Makatea, "~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Bayesian/Healthy_Likelihood_Makatea.csv")


### Reload dataframes - and all environmental data

# Likelihood healthy
Healhty_Likelihood_Moorea <- read.csv("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/Bayesian/Healthy_Likelihood_Moorea.csv", sep=",", dec=",")
Healhty_Likelihood_Makatea <- read.csv("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/Bayesian/Healthy_Likelihood_Makatea.csv", sep=",", dec=",")
Healthy_Likelihood <- read.csv("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Deep_Bleaching_French_Polynesia/Data/Bayesian/Healthy_Likelihood.csv", sep=",", dec=",")



# Loggers Temp
Index_Temp_Moorea <- read.csv("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Temperature_Loggers/MOO1/MOO1_Temp_Index.csv", sep=",", dec=",")
Index_Temp_Makatea <- read.csv("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Temperature_Loggers/MAKATEA/MAK1/MAK1_Temp_Index.csv", sep=",", dec=",")
...
likelihood_plot <- ggplot(Profiles_vs_Likelihood, aes (Depth)) +
  ...
  theme_classic() + theme(strip.background = element_blank())
ggsave("~/Documents/AAASea_Science/AAA_PhD_Thesis/Bleaching_2019/Figures/Likelihood_Temp_Light.pdf", width = 12, height = 6, units = "cm")
likelihood_plot 
